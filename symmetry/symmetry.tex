...
\sectionugent{Application: the slab waveguide}
...
If we make a plot of wave vector (spatial behaviour) versus frequency (temporal behaviour) for the slab waveguide, the different bands correspond to different lines that rise uniformly in frequency. This \texbf{band structure} is shown in Fig.~\ref{fig-slab-disp}. It has been computed by solving Maxwell's equations numerically.
