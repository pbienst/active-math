...
\begin{cue}
Multiply the generating function by itself and by $e^{-x^2}$. Careful: can you use $t$ in both copies of the generating function? Afterwards, integrate from $-\infty$ to $\infty$ and simplify. 
\end{cue}
