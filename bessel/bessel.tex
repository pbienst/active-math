...
\noindent\marginnote{Strictly speaking, the $n$ from $n+1$ is a different $n$, but these indices are in fact only throw-away variables.}Or with the substitution $n+1 \to n$
...
Based on what we've seen before (Eq.\ref{eq-bessel}), $R$ has to satisfy this equation:
