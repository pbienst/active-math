...
\begin{marginfigure}[7.0cm]
  ...
  \caption{Franz Ernst Neumann (1798 – 1895)}
\end{marginfigure}
...
\noindent\marginnote{Franz Ernst, not John von.}This function is also called the \emph{Neumann} function, and is sometimes symbolised by $N_\nu(x)$.
