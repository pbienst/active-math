...
\begin{equation}
x^2 J_n''(x) + (n + 1) x J_n'(x) - x J_{n-1}(x) - x^2 J_{n-1}'(x)= 0 \label{eq-bessel-dif-rec-b}
\end{equation} 

Looking at the second term, Bessel's differential equation has $x J_n'(x)$ rather than $(n + 1) x J_n'(x)$. Let's rectify this!

\begin{cue}
From Eq.~\ref{eq-bessel-dif-rec-b}, subtract Eq.~\ref{eq-bessel-dif-rec} multiplied by $n$.
\end{cue}
